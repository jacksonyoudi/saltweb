...
def showallline(request):
    if request.user.is_superuser:
        ...
        scale=100000
        return  render_to_response('allline.html', {'flow': json.dumps(dataline),'labels': json.dumps(labels),'end': json.dumps(end),'scale': json.dumps(scale),'username':username,'program':json.dumps(m)})
    else:
        return render_to_response("505.html")
...
def updateline(request):
    ...
    if  a == "ldzw":
        m='乱斗之王'
        labels,dataline=submitdate(m,request)
        return  render_to_response('gameline.html', {'flow': json.dumps(dataline),'labels': json.dumps(labels),'username':username,'program':m,'one':one,'two':two})
    ...
    if a == "admin":
        ...
        if request.POST['three'] == u'所有游戏业务项目':
            ...
            cqb=u''
            tkzz=u''
            return  render_to_response('allline.html', {'flow': json.dumps(dataline),'labels': json.dumps(labels),'end': json.dumps(end),'scale': json.dumps(scale),'username':username,'program':m,'one':one,'two':two,'three':three,'all':all,'ldzw':ldzw,'cqb':cqb,'tkzz':tkzz})
        ...
        if request.POST['three'] == u'苍穹变':
            ...
            ldzw=u''
            tkzz=u''
            return  render_to_response('allline.html', {'flow': json.dumps(dataline),'labels': json.dumps(labels),'end': json.dumps(end),'scale': json.dumps(scale),'username':username,'one':one,'two':two,'three':three,'all':all,'ldzw':ldzw,'cqb':cqb,'tkzz':tkzz})
...
def showline(request):
    ...
    if a == "ldzw":
        m = '乱斗之王'
        labels,dataline = data(m)
        return  render_to_response('showlineuser.html', {'flow': json.dumps(dataline),'labels': json.dumps(labels),'username':username,'program':m,'one':one,'two':two})
    ...
    if a == "admin":
        ...
        scale = 200000
        return render_to_response('showline.html', {'flow': json.dumps(dataline),'labels': json.dumps(labels),'end': json.dumps(end),'scale': json.dumps(scale),'username':username,'program':json.dumps(m),'one':one,'two':two})

@login_required(login_url="/account/")
def showlinedate(request):
    all=u''
    ldzw=u''
    cqb=u''
    tkzz=u''
    ...
    if a == "admin":
        ...
        if request.POST['three'] == u'所有游戏业务项目':
            ...
            cqb=u''
            tkzz=u''
            return  render_to_response('showline.html', {'flow': json.dumps(dataline),'labels': json.dumps(labels),'end': json.dumps(end),'scale': json.dumps(scale),'username':username,'program':json.dumps(m),'one':one,'two':two,'three':three,'all':all,'ldzw':ldzw,'cqb':cqb,'tkzz':tkzz})
        ...
        if request.POST['three'] == u'苍穹变':
            ...
            ldzw=u''
            tkzz=u''
            return  render_to_response('showline.html', {'flow': json.dumps(dataline),'labels': json.dumps(labels),'end': json.dumps(end),'scale': json.dumps(scale),'username':username,'one':one,'two':two,'three':three,'all':all,'ldzw':ldzw,'cqb':cqb,'tkzz':tkzz,'program':json.dumps(m)})
        if request.POST['three'] == u'坦克之战':
            m = '坦克之战'
            labels,dataline=datadate(m,request)
            username=request.user.username
...
''' def table(request):
    ...
    if  a == "ldzw":
        ...
        labels,dataline=submitdate(m,request)
        print labels,dataline
        return  render_to_response('showtable.html', {'flow': json.dumps(dataline),'labels': json.dumps(labels),'username':username,'program':m,'one':one,'two':two})
    ...
    if a == "admin":
        ...
        if request.POST['three'] == u'所有游戏业务项目':
            ...
            cqb=u''
            tkzz=u''
            return  render_to_response('showtable.html', {'flow': json.dumps(dataline),'labels': json.dumps(labels),'end': json.dumps(end),'scale': json.dumps(scale),'username':username,'program':m,'one':one,'two':two,'three':three,'all':all,'ldzw':ldzw,'cqb':cqb,'tkzz':tkzz})
        ...
        if request.POST['three'] == u'苍穹变':
            ...
            ldzw=u''
            tkzz=u''
            return  render_to_response('showtable.html', {'flow': json.dumps(dataline),'labels': json.dumps(labels),'end': json.dumps(end),'scale': json.dumps(scale),'username':username,'one':one,'two':two,'three':three,'all':all,'ldzw':ldzw,'cqb':cqb,'tkzz':tkzz})
        if request.POST['three'] == u'坦克之战':
            m = '坦克之战'
            labels,dataline=datadate(m,request)
            username=request.user.username
